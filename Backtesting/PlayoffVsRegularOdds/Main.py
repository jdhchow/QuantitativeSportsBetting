...
Exploration of regular season vs playoff NHL odds
'''
...
if __name__ == '__main__':
    ...
    reg, playoff = completeData.loc[completeData['game.type'] == 'R'].copy(), \
                   completeData.loc[completeData['game.type'] == 'P'].copy()

    # Compute anova of the means
    ftest, pval = f_oneway(reg['favourite.WagerReturns'],
                           reg['tie.WagerReturns'],
                           reg['nonfavourite.WagerReturns'],
                           playoff['favourite.WagerReturns'],
                           playoff['tie.WagerReturns'],
                           playoff['nonfavourite.WagerReturns'])
    ...
    x = np.array(['Reg Favourite', 'Reg Tie', 'Reg Non-Favourite',
                  'Playoff Favourite', 'Playoff Tie', 'Playoff Non-Favourite'])
    y = np.array([reg['favourite.WagerReturns'].mean(),
                  reg['tie.WagerReturns'].mean(),
                  reg['nonfavourite.WagerReturns'].mean(),
                  playoff['favourite.WagerReturns'].mean(),
                  playoff['tie.WagerReturns'].mean(),
                  playoff['nonfavourite.WagerReturns'].mean()])
    e = np.array([np.std(reg['favourite.WagerReturns']),
                  np.std(reg['tie.WagerReturns']),
                  np.std(reg['nonfavourite.WagerReturns']),
                  np.std(playoff['favourite.WagerReturns']),
                  np.std(playoff['tie.WagerReturns']),
                  np.std(playoff['nonfavourite.WagerReturns'])])
