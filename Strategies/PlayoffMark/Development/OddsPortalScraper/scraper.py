...
"""
    Scraper interface for grabbing things off of odds-portal (trying to make it somewhat
    reusable in case we want to scrape other things later)

    Scraper will be used as follows:
